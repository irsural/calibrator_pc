...
class Ui_settings_dialog(object):
    def setupUi(self, settings_dialog):
        ...
        settings_dialog.resize(563, 416)
...
"}")
    ...
    def retranslateUi(self, settings_dialog):
        ...
        item.setText(_translate("settings_dialog", "Дополнительные параметры измерений"))
        ...
        item.setText(_translate("settings_dialog", "Другие параметры измерения"))
        ...
        self.disable_scroll_on_table_checkbox.setText(_translate("settings_dialog", "Отключить прокрутку шага,\n"
"если курсор мыши находится\n"
"на таблице измерения"))
        self.mouse_inversion_checkbox.setText(_translate("settings_dialog", "Инвертировать\n"
"колесо мыши"))
        self.label_4.setWhatsThis(_translate("settings_dialog", "<html><head/><body><p>Во время измерения, при нажатии кнопки &quot;Перейти к точке&quot;, на калибраторе будет установлено значение: </p><p>&quot;выбранная точка +(-) начальное отклонение&quot;. </p><p>Начальное отклонение задается в процентах от максимума шкалы поверяемого прибора.</p></body></html>"))
        self.label_4.setText(_translate("settings_dialog", "Начальное отклонение, %"))
