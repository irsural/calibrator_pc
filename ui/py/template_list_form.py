...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.remove_point_button.setAutoDefault(False)
        ...
        self.scales_widget_layout = QtWidgets.QGridLayout()
        self.scales_widget_layout.setSizeConstraint(QtWidgets.QLayout.SetDefaultConstraint)
        self.scales_widget_layout.setObjectName("scales_widget_layout")
        self.gridLayout_3.addLayout(self.scales_widget_layout, 1, 0, 1, 3)
        ...
        Dialog.setTabOrder(self.remove_point_button, self.choose_template_button)
