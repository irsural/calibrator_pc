...
class Ui_MainForm(object):
    def setupUi(self, MainForm):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(90, 100, 256, 192))
    ...
    def retranslateUi(self, MainForm):
        ...
        item.setText(_translate("MainForm", "4"))
        item = self.tableWidget.verticalHeaderItem(4)
        item.setText(_translate("MainForm", "5"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("MainForm", "11111"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("MainForm", "22222"))
        __sortingEnabled = self.tableWidget.isSortingEnabled()
        self.tableWidget.setSortingEnabled(False)
        item = self.tableWidget.item(0, 0)
        item.setText(_translate("MainForm", "1"))
        item = self.tableWidget.item(0, 1)
        item.setText(_translate("MainForm", "6"))
        item = self.tableWidget.item(1, 0)
        item.setText(_translate("MainForm", "2"))
        item = self.tableWidget.item(1, 1)
        item.setText(_translate("MainForm", "7"))
        item = self.tableWidget.item(2, 0)
        item.setText(_translate("MainForm", "3"))
        item = self.tableWidget.item(2, 1)
        item.setText(_translate("MainForm", "8"))
        item = self.tableWidget.item(3, 0)
        item.setText(_translate("MainForm", "4"))
        item = self.tableWidget.item(3, 1)
        item.setText(_translate("MainForm", "9"))
        item = self.tableWidget.item(4, 0)
        item.setText(_translate("MainForm", "5"))
        item = self.tableWidget.item(4, 1)
        item.setText(_translate("MainForm", "10"))
