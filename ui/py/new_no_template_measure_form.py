...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.upper_bound_edit.setMinimumSize(QtCore.QSize(110, 0))
        self.upper_bound_edit.setMaximumSize(QtCore.QSize(110, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.upper_bound_edit.setFont(font)
        self.upper_bound_edit.setObjectName("upper_bound_edit")
        self.horizontalLayout_3.addWidget(self.upper_bound_edit)
        self.units_wildcard_2 = QtWidgets.QLabel(Dialog)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.units_wildcard_2.setFont(font)
        self.units_wildcard_2.setObjectName("units_wildcard_2")
        self.horizontalLayout_3.addWidget(self.units_wildcard_2)
        self.gridLayout.addLayout(self.horizontalLayout_3, 3, 1, 1, 1)
        self.accuracy_spinbox = QtWidgets.QSpinBox(Dialog)
        self.accuracy_spinbox.setMinimumSize(QtCore.QSize(110, 0))
        self.accuracy_spinbox.setMaximumSize(QtCore.QSize(110, 16777215))
        ...
        self.gridLayout.addWidget(self.accuracy_spinbox, 5, 1, 1, 1)
        ...
        self.clb_list_combobox.setMinimumSize(QtCore.QSize(110, 0))
        self.clb_list_combobox.setMaximumSize(QtCore.QSize(110, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.lower_bound_edit.setMinimumSize(QtCore.QSize(110, 0))
        self.lower_bound_edit.setMaximumSize(QtCore.QSize(110, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lower_bound_edit.setFont(font)
        self.lower_bound_edit.setObjectName("lower_bound_edit")
        self.horizontalLayout_2.addWidget(self.lower_bound_edit)
        self.units_wildcard_1 = QtWidgets.QLabel(Dialog)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.units_wildcard_1.setFont(font)
        self.units_wildcard_1.setObjectName("units_wildcard_1")
        self.horizontalLayout_2.addWidget(self.units_wildcard_1)
        ...
        self.display_resolution_combobox.setMinimumSize(QtCore.QSize(110, 0))
        self.display_resolution_combobox.setMaximumSize(QtCore.QSize(110, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.display_resolution_combobox.addItem("")
        self.display_resolution_combobox.addItem("")
        self.gridLayout.addWidget(self.display_resolution_combobox, 5, 0, 1, 1)
        ...
        self.step_edit.setMinimumSize(QtCore.QSize(110, 0))
        self.step_edit.setMaximumSize(QtCore.QSize(110, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.step_edit.setFont(font)
        self.step_edit.setObjectName("step_edit")
        self.horizontalLayout_5.addWidget(self.step_edit)
        self.units_wildcard_3 = QtWidgets.QLabel(self.auto_calc_points_checkbox)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.units_wildcard_3.setFont(font)
        self.units_wildcard_3.setObjectName("units_wildcard_3")
        self.horizontalLayout_5.addWidget(self.units_wildcard_3)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_7.setText(_translate("Dialog", "Точность подхода к точке, %"))
        self.lower_bound_edit.setText(_translate("Dialog", "0"))
        self.units_wildcard_1.setText(_translate("Dialog", "А"))
        ...
        self.units_wildcard_3.setText(_translate("Dialog", "В"))
