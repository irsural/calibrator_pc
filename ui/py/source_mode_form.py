...
class Ui_source_mode_dialog(object):
    def setupUi(self, source_mode_dialog):
        ...
        self.frame = QtWidgets.QFrame(source_mode_dialog)
        ...
        self.clb_list_combobox = QtWidgets.QComboBox(source_mode_dialog)
        ...
        self.dci_radio = QtWidgets.QRadioButton(source_mode_dialog)
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.dcv_radio = QtWidgets.QRadioButton(source_mode_dialog)
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.apply_amplitude_button = QtWidgets.QPushButton(source_mode_dialog)
        ...
        self.frequency_edit = QEditCopyButton(source_mode_dialog)
        ...
        self.amplitude_edit = QEditCopyButton(source_mode_dialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        ...
        self.apply_frequency_button = QtWidgets.QPushButton(source_mode_dialog)
        ...
        self.label_6 = QtWidgets.QLabel(source_mode_dialog)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.label_5 = QtWidgets.QLabel(source_mode_dialog)
        ...
        self.source_mode_radio = QtWidgets.QRadioButton(source_mode_dialog)
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.buttonGroup_2 = QtWidgets.QButtonGroup(source_mode_dialog)
        self.buttonGroup_2.setObjectName("buttonGroup_2")
        self.buttonGroup_2.addButton(self.source_mode_radio)
        self.horizontalLayout_5.addWidget(self.source_mode_radio)
        self.fixed_mode_radio = QtWidgets.QRadioButton(source_mode_dialog)
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.detuning_radio = QtWidgets.QRadioButton(source_mode_dialog)
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.enable_button = QtWidgets.QPushButton(source_mode_dialog)
        font = QtGui.QFont()
        font.setPointSize(15)
    ...
    def retranslateUi(self, source_mode_dialog):
        ...
        source_mode_dialog.setWindowTitle(_translate("source_mode_dialog", "Dialog"))
        self.label_4.setText(_translate("source_mode_dialog", "Статус:"))
        self.clb_state_label.setText(_translate("source_mode_dialog", "Остановлен"))
        self.aci_radio.setText(_translate("source_mode_dialog", "I~"))
        self.acv_radio.setText(_translate("source_mode_dialog", "U~"))
        self.dci_radio.setText(_translate("source_mode_dialog", "I="))
        self.dcv_radio.setText(_translate("source_mode_dialog", "U="))
        self.frequency_edit.setText(_translate("source_mode_dialog", "0"))
        self.amplitude_edit.setText(_translate("source_mode_dialog", "0"))
        self.label_6.setText(_translate("source_mode_dialog", "Частота, Гц"))
        self.label_5.setText(_translate("source_mode_dialog", "Амплитуда"))
        self.source_mode_radio.setText(_translate("source_mode_dialog", "Источник"))
        self.fixed_mode_radio.setText(_translate("source_mode_dialog", "Фиксир."))
        self.detuning_radio.setText(_translate("source_mode_dialog", "Расстройка"))
        self.enable_button.setText(_translate("source_mode_dialog", "Старт"))
